...
<head>
    ...
    <title>Forgot Password - Diskominfo Kutai Barat</title>
...
<body class="bg-gray-100 font-sans antialiased min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-md bg-white rounded-[2rem] shadow-2xl p-8 border border-gray-100">
        <div class="text-center mb-6">
            ...
            <p class="text-sm text-gray-400 mt-1">Masukkan email terdaftar untuk menerima link verifikasi</p>
        </div>
        ...
        <div class="text-center text-xs font-semibold mt-4 text-gray-400">
            Kembali ke halaman <a href="/login-page" class="text-[#1e4693] hover:underline">Log In</a>
        </div>
    </div>
</body>
</html>